    ...
    <>
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 md:px-6 flex items-center justify-between h-[54px] md:h-[60px]">
          <Link href="/" className="relative block h-8 md:h-[38px] w-[130px] md:w-[160px] flex-shrink-0">
            <NetlifyImage
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <a href="tel:0468347781" className="hidden md:flex items-center gap-2 text-navy font-semibold text-[15px]">
              <svg className="w-4 h-4 shrink-0 stroke-burnt-orange" fill="none" viewBox="0 0 24 24" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
      ...
      <section className="relative bg-navy overflow-hidden">
        ...
        <div className="relative max-w-[1160px] mx-auto px-[18px] md:px-[40px] pt-[22px] pb-[26px] md:pt-[44px] md:pb-[48px]">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_400px] md:gap-[52px] items-start">

            {/* Left column */}
            <div>
              {/* Trust badge */}
              <div className="inline-flex items-center gap-2 md:gap-[10px] rounded-full px-3 md:px-[14px] py-[6px] md:py-[7px] mb-4 md:mb-[22px]" style={{ background: 'rgba(255,255,255,.08)', border: '1px solid rgba(255,255,255,.16)' }}>
                <span className="inline-flex gap-[1px] md:gap-[2px]">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <svg key={i} className="w-3 h-3 md:w-[15px] md:h-[15px]" viewBox="0 0 20 20" fill="#facc15">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                </span>
                <span className="text-white font-semibold text-[11.5px] md:text-[13px]">5.0 on Google</span>
              ...
              {/* Subhead */}
              <p className="text-[14.5px] md:text-[18px] font-medium mt-[9px] md:mt-3 m-0 text-white">
                (Without Postpones, Permits or Paperwork)
              </p>

              {/* Before/After — mobile only (appears above checklist) */}
              <div className="relative flex gap-[10px] mt-[18px] md:hidden">
                {/* 72-hour sticker */}
              ...
              {/* Checklist */}
              <ul className="mt-[18px] md:mt-[26px] flex flex-col gap-[10px] md:gap-[13px] list-none p-0 m-0">
                {[
              ...
              {/* Review quote */}
              <div className="mt-[22px] md:mt-[30px] max-w-full md:max-w-[520px] rounded-xl px-[16px] py-[15px] md:px-[20px] md:py-[18px]" style={{ background: 'rgba(255,255,255,.06)', borderTop: '1px solid rgba(255,255,255,.12)', borderRight: '1px solid rgba(255,255,255,.12)', borderBottom: '1px solid rgba(255,255,255,.12)', borderLeft: '4px solid #FF7F00' }}>
                ...
                <div className="flex items-center gap-[9px] md:gap-[10px] mt-[11px] md:mt-[13px]">
