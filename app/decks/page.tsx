...
export default function Decks() {
  return (
    <>
      ...
      {/* Gallery + testimonial */}
      <section id="section-gallery" className="py-10 bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          {/* Eyebrow */}
          <div className="flex items-center gap-2.5 mb-3.5">
            <span className="w-[22px] h-0.5 bg-burnt-orange rounded" />
            <span className="text-[12.5px] font-bold tracking-[.16em] uppercase text-burnt-orange">Our Work</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-10">
            ...
            {/* Faizan Asghar */}
            <div className="relative bg-white border border-gray-100 border-t-[3px] border-t-burnt-orange rounded-2xl p-[30px] shadow-[0_16px_40px_-20px_rgba(4,44,92,.22)]">
              <span className="absolute top-2.5 right-6 font-serif text-[88px] leading-none text-navy opacity-[.08] select-none pointer-events-none">&rdquo;</span>
              <div className="flex gap-0.5 mb-4">
                {Array.from({ length: 5 }).map((_, i) => (
                  <svg key={i} className="w-[18px] h-[18px]" viewBox="0 0 20 20" fill="#fbbc04">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                ))}
              </div>
              <p className="text-[16.5px] leading-relaxed font-medium text-gray-800 mb-5">Clean carpentry work, strong build, completed on time and at a very good price. Highly recommend.</p>
              <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                <span className="w-[42px] h-[42px] rounded-full flex items-center justify-center text-white text-[15px] font-bold shrink-0" style={{ backgroundColor: '#34a853' }}>FA</span>
                <div className="leading-tight">
                  <p className="text-[15px] font-bold text-gray-900">Faizan Asghar</p>
                  <p className="text-[12.5px] text-gray-400">4 months ago</p>
                </div>
                <div className="ml-auto flex items-center gap-1.5">
                  <svg viewBox="0 0 24 24" className="w-[17px] h-[17px]" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/>
                    <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
                    <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/>
                    <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/>
                  </svg>
                  <span className="text-[12.5px] text-gray-400 font-medium">Google Review</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative bg-white border border-gray-100 border-t-[3px] border-t-burnt-orange rounded-2xl p-[30px] shadow-[0_16px_40px_-20px_rgba(4,44,92,.22)]">
              ...
              <p className="text-[16.5px] leading-relaxed font-medium text-gray-800 mb-5">Highly recommend Stickbuild Construction! We had a side pergola that was incredibly rotten and dangerous. The team came out and took the entire thing down within a single day. They cleared away all the rubbish, leaving the side path clean. We are very happy with their fast, professional service and can&apos;t wait to work with them again soon to build our new pergola!</p>
              <div className="flex items-center gap-3 pt-4 border-t border-gray-100">
                <span className="w-[42px] h-[42px] rounded-full flex items-center justify-center text-white text-[15px] font-bold shrink-0" style={{ backgroundColor: '#1a73e8' }}>JW</span>
                <div className="leading-tight">
                  <p className="text-[15px] font-bold text-gray-900">Jack Williams</p>
                  <p className="text-[12.5px] text-gray-400">1 month ago</p>
                </div>
                <div className="ml-auto flex items-center gap-1.5">
                  <svg viewBox="0 0 24 24" className="w-[17px] h-[17px]" xmlns="http://www.w3.org/2000/svg">
                    <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-5">
            {features.map((feature) => (
              <li key={feature} className="flex items-start gap-3 text-white text-base md:text-xl leading-relaxed">
                <span className="w-5 h-5 md:w-6 md:h-6 rounded-full bg-burnt-orange flex items-center justify-center shrink-0 mt-1 md:mt-1">
